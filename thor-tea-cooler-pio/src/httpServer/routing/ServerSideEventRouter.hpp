...
public:
    ServerSideEventRouter(TtcHardware *hw_, PsychicHttpsServer *server_, String eventPath);
...
ServerSideEventRouter::ServerSideEventRouter(TtcHardware *hw_, PsychicHttpsServer *server_, String eventPath)
{
